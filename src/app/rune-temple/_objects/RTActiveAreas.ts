...
export class RuneTempleGameActiveAreas {
    activeAreas: GameAreas = {
        ...
        summon: [
            ...
            new ActiveArea('RuneMural1', 'rm1', 0, 0, false),
            new ActiveArea('RuneMural2', 'rm2', 0, 0, false),
            new ActiveArea('RuneMural3', 'rm3', 0, 0, false),
            new ActiveArea('RuneMural4', 'rm4', 0, 0, false),
            new ActiveArea('RuneMural4Partial', 'rm4partial', 0, 0),
            new ActiveArea('RuneMural5', 'rm5', 0, 0, false),
            new ActiveArea('RuneMural6', 'rm6', 0, 0, false),
            new ActiveArea('RuneMural7', 'rm7', 0, 0, false),
