import { DialogueSnippet, GameDialogue } from '../../pn-c-game/_objects/DialogueSnippet';



export class RuneTempleDialogue {
    ...
    gameDialogue: GameDialogue = {
        ...
        activeAreas: {
            ...
            dark: [new DialogueSnippet('Erin', 'I have no idea what\'s down here.  I\'m not stumbling around in the dark.')],
